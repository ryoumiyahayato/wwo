...
- 1,619个生产成员字段的静态逐项索引由[`variable_state_member_inventory.md`](variable_state_member_inventory.md)单独持有。
- 第一批只删除玩家所属国家的一个重复运行期成员，并机械调整继承回滚和SAVE_VERSION=1存档边界；未处理其他状态组。
- 扫描范围为522个源/配置文件、274个GDScript文件。
...
|---|---:|---:|---:|
| 生产成员字段 | 1,613 | 1,619 | -1 |
| 可写成员字段 | 1,243 | 1,241 | -1 |
| 进程级全局可写字段 | 16 | 15 | -1 |
| Autoload可写字段 | 0 | 0 | 0 |
