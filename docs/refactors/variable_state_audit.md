...
- 1,866个生产成员字段的静态逐项索引由[`variable_state_member_inventory.md`](variable_state_member_inventory.md)单独持有。
...
|---|---:|---:|---:|
| 生产成员字段 | 1,613 | 1,866 | -1 |
| 可写成员字段 | 1,243 | 1,383 | -1 |
| 进程级全局可写字段 | 16 | 15 | -1 |
| Autoload可写字段 | 0 | 0 | 0 |
