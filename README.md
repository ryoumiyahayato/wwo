...
目标 P0 Demo 包含两个架空国家、双层二维地图、人物随机开局、行动与组织、简化 AI、继承、存档和开发工具。历史 Windows 11 x86-64 系统原型已经成功导出；当前默认分支仍处于 `P0-R1` 修复与复验阶段，不能视为发布候选。
...
上述审计后修改尚未在本机重新执行完整验证脚本，因此没有新的绿色通过数量。全部自动测试、1280×720 人工旅程、保存加载、30 日与一年模拟和 Windows 重新导出通过前，不得将当前版本标记为完成的 P0 Demo。
