...
extends RefCounted
## Lightweight record: deliberately excludes full skills, aptitudes, tendencies and AI.
...
func to_dict() -> Dictionary:
	return {
		"id": id, "name": name, "age": age, "country_id": country_id,
		"region_id": region_id, "occupation_id": occupation_id,
		"occupation": occupation, "public_position": public_position,
