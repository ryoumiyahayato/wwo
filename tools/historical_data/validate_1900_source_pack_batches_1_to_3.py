#!/usr/bin/env python3
"""Aggregate source-pack validation for Batches 1 through 3."""
...
REPORT_PATH = ROOT / "data" / "staging" / "1900" / "batch3_qa_report.json"
...
def main() -> int:
    ...
    report = {
        "schema_id": "wwo_1900_source_pack_batches_1_to_3_qa_report_v1",
        "batches": [1, 2, 3],
        "checks": checks,
